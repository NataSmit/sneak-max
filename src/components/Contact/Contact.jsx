...
export default function Contact() {
  return (
    <section className={styles.contact}>
      <Box sx={{py: 5, maxWidth: 1152, my: 0, mx: 'auto', display: 'flex', justifyContent: 'space-between'}}>
        <Box sx={{marginRight: 10}}>
          ...
          <Typography sx={{color: 'rgba(68, 75, 88, 1)', fontWeight: 400, marginBottom: 2}} variant='h4'>+7 800 800 00 00</Typography>
          <Typography sx={{color: 'rgba(68, 75, 88, 1)', fontWeight: 400, marginBottom: 6}}>г. Санкт-Петербург, Комсомольская, 43 к1</Typography>
          <ul className={styles.list}>
            <li className={styles.social}><a href='#'><img src={VK} alt='VK'/></a></li>
            <li className={styles.social}><a href='#'><img src={Inst} alt='Inst'/></a></li>
          </ul>
        </Box>
        <Box>
          <Map />
